...
export default class Announcement {
  ...
  renderTemplate() {
    ...
    document.getElementById('file-upload').addEventListener('change', function() {
      ...
      if (file) {
          ...
          reader.onload = function(e) {
              document.querySelector('.announcement__preview-image').src = e.target.result;
          };
    ...
    this.form.querySelector('#name').addEventListener('input', (event) => {
      ...
      const previewTitle = document.querySelector('.announcement__preview-title'); // Ensure this element exists in your HTML.
      if (previewTitle) {
    ...
    this.form.querySelector('#description').addEventListener('input', (event) => {
      // Ensure the event listener is using the event parameter to get the current value.
      const previewDescription = document.querySelector('.announcement__preview-desription'); // Ensure this element exists in your HTML.
  ...
  submit() {
    const form = document.querySelector('#announcement');
