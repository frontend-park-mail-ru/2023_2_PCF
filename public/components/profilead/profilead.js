...
export default class ProfileAd {
  ...
  renderTemplate() {
    ...
    const adList = document.getElementById('profilead__main__container__left__adlayout__ads--list');
    adList.innerHTML = '';
  ...
  showSelectedAd(ad) {
    ...
    const photoprofilead = document.getElementById('profilead__ad__photo');
